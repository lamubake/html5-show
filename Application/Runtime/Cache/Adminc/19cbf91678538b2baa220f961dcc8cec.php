					...
					<div class="span12">
                     ...
                     站点导航设置
						...
						<ul class="breadcrumb">
							...
							<li><a href="#"><?php if($type == '13'): ?>顶部<?php endif; if($type == '14'): ?>底部<?php endif; ?>导航管理 </a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom boxless">
							...
							<ul class="nav nav-tabs">
								...
								<li <?php if($type == '13'): ?>class="active"<?php endif; ?>><a href="adminc.php?c=ad&filetype=13">顶部导航管理</a></li>
								<li <?php if($type == '14'): ?>class="active"<?php endif; ?>><a class="" href="adminc.php?c=ad&filetype=14">底部导航管理</a></li>
                                <li <?php if($type == '5'): ?>class="active"<?php endif; ?>><a class="" href="adminc.php?c=ad&filetype=15">辅助导航管理</a></li>
							</ul>

							<div class="tab-content ">
								<div class="tab-pane active" id="scene_type">
									<div class="portlet box grey">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i> <?php if($type == '13'): ?>顶部<?php endif; if($type == '14'): ?>底部<?php endif; if($type == '5'): ?>辅助<?php endif; ?>导航管理 </div>
										</div>
										<div class="portlet-body form">
                                         <p>
               <a  href='?c=ad&a=dh_add&type=<?php echo ($type); ?>' style='margin-bottom: 2px; ' class="btn green ">添加<?php if($type == '13'): ?>顶部<?php endif; if($type == '14'): ?>底部<?php endif; if($type == '5'): ?>辅助<?php endif; ?>导航</a>
            </p> 
                        ...
                        <tr>
                            ...
                            <th scope="col" >
                               链接地址</th>
                            <th scope="col" width="30px">排序</th>
                            <th scope="col">
                                添加时间
                            </th>
                             <th align="center" scope="col" abbr="lbtnOperate" width="150px">操作</th>
                        </tr>
                              ...
                              <?php if(is_array($select)): foreach($select as $key=>$item): ?><tr onMouseOver="this.className='RecordRowOver'" onMouseOut="this.className=''">
                                    ...
                                    <td> <h4><?php echo ($item["name"]); ?>
                                    <img src="<?php echo ($item["logo"]); ?>" class="qr-code"  > </h4>
                                    </td>
                                    ...
                                    <?php if($item['create_time'] > 0): echo (date("Y-m-d",$item["create_time"])); endif; ?>
                                       ...
                                       <td align="center" > <a href="?c=ad&a=dh_e&id=<?php echo ($item["id"]); ?>" class="btn blue"> 编辑导航 </a> 
                                    <a href="javascript:;" onClick="javascript:if(confirm('你确信要删除[<?php echo ($item["name"]); ?>]吗？')) window.location='?c=ad&a=del&id=<?php echo ($item["id"]); ?>&type=<?php echo ($type); if(($flag) == "useranli"): ?>&flag=useranli<?php endif; ?>'" class="btn black"> 删 除</a>
