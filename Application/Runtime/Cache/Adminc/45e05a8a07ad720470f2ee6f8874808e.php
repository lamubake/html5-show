       ...
       <form action="" method="post" class="form-horizontal">
            ...
            <table style="vertical-align: top;">
                <tr>
                    ...
                    <td>
                  <input name="site_name" type="text" value="<?php echo (C("site_name")); ?>" /><span>&nbsp;&nbsp;例：一秀</span>
                    </td>
                </tr>
         <tr> 
...
<span> 默认：#d0cfd8 </span></td>
     ...
     <tr> 
      ...
      <td><input type="text" name="lastpagetext" value="<?php echo (C("lastpagetext")); ?>" style="width:120px"/><span>&nbsp;&nbsp;例：一秀</span> &nbsp;&nbsp;
