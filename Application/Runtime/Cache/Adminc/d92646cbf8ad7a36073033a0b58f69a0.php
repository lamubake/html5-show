...
<input name="msg[title]" type="text"   class="frm_input" style="width: 200px;" value="<?php echo ($msglist["title"]); ?>" /></span>
                    </td>
</tr>
 
  <tr>
  <td> <strong class="btn purple-stripe">内容</td>
                    <td><textarea name="msg[content]" style="width:450px;height:60px;margin:5px 0 5px 0;"><?php echo ($msglist["content"]); ?></textarea> <span>&nbsp;&nbsp;一般不超过200个字符</span>
              </tr>
 
            </table>
          <div class="form-actions">
                <span id="Span1" class="btn btn_primary btn_input">
                 <input type="hidden"  name="id" value="<?php echo ($msglist["id"]); ?>" />
