...
<div class="container-fluid">
                ...
                <li class="<?php echo ($ui["Database"]); ?>"> <a href="<?php echo U('/Database/index/type/export');?>"> 数据备份</a> </li>
                <li class=""> <a href="<?php echo U('/Database/index/type/import');?>"> 数据还原</a> </li>
							</ul>
                            <hr>
                </div>
				<!-- BEGIN PAGE CONTENT-->          
 ...
 <div class="data-table table-striped">
      <form id="export-form" method="post"  name="myform"  action="<?php echo U('export');?>">       
...
<th class="sorting" style="width: 121px;">操作</th>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$table): $mod = ($i % 2 );++$i;?><tr>
                           <td class=" num">
                                <input  onClick="unselectall(this.form)"   type="checkbox" name="tables[]" value="<?php echo ($table["name"]); ?>">
                            </td>
                            <td><?php echo ($table["name"]); ?></td>
                            <td><?php echo ($table["rows"]); ?></td>
                     <td><?php echo (byteFormat($table["data_length"])); ?></td>
