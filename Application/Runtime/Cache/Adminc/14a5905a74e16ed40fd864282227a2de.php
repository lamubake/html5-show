...
<div class="container-fluid">
                ...
                <li > <a href="<?php echo U('/Database/index/type/export');?>"> 数据备份</a> </li>
                <li class="<?php echo ($ui["Database"]); ?>"> <a href="<?php echo U('/Database/index/type/import');?>"> 数据还原</a> </li>
							</ul>
                            <hr>
                </div>
				<!-- BEGIN PAGE CONTENT-->          
          ...
          <th class="sorting" style="width: 185px;">备份名称</th>
            ...
            <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo (byteFormat($data["size"])); ?></td>
                        <td><?php echo ($key); ?></td>
                        <td>-</td>
                        <td class="action">
                            <a class="db-import btn blue" href="<?php echo U('import?time='.$data['time']);?>">还原</a>&nbsp;
                            <a class="ajax-get btn confirm" href="<?php echo U('del?time='.$data['time']);?>">删除</a>
                        </td>
